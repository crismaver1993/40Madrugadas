...
private NestedScrollView scrol;
    ...
    private FloatingActionButton fabRemoveMark,fabMark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtOrandoPor=(TextView) findViewById(R.id.txtOrandoPor);
        txtPersonas=(TextView) findViewById(R.id.txtPersonas);
        scrol=(NestedScrollView)findViewById(R.id.scrol);

        fabRemoveMark=(FloatingActionButton)findViewById(R.id.fabRemoveMark);
                fabMark= (FloatingActionButton)findViewById(R.id.fabMark);
...
//Quitamos barra de notificaciones
        ...
        //REALM
        mRealm = Realm.getInstance(ContenidoActivity.this);//REALM
